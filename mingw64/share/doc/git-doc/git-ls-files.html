...
<body class="manpage">
<div id="header">
<h1>git-ls-files(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<dt class="hdlist1">--no-empty-directory</dt>
<dd>
...
<dt class="hdlist1">-X &lt;file&gt;</dt>
<dt class="hdlist1">--exclude-from=&lt;file&gt;</dt>
<dd>
<p>Read exclude patterns from &lt;file&gt;; 1 per line.</p>
</dd>
<dt class="hdlist1">--exclude-per-directory=&lt;file&gt;</dt>
<dd>
...
<dt class="hdlist1">--error-unmatch</dt>
<dd>
<p>If any &lt;file&gt; does not appear in the index, treat this as an
error (return 1).</p>
</dd>
<dt class="hdlist1">--with-tree=&lt;tree-ish&gt;</dt>
<dd>
...
path. (see <a href="git-read-tree.html">git-read-tree(1)</a> for more information on state)</p>
</div>
<div class="paragraph">
