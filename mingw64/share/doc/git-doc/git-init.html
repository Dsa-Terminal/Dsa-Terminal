...
<dt class="hdlist1">--object-format=&lt;format&gt;</dt>
<dd>
...
<dt class="hdlist1">-b &lt;branch-name</dt>
<dt class="hdlist1">--initial-branch=&lt;branch-name&gt;</dt>
<dd>
<p>Use the specified name for the initial branch in the newly created repository.
If not specified, fall back to the default name: <code>master</code>.</p>
</dd>
...
"exclude patterns" (see <a href="gitignore.html">gitignore(5)</a>), and sample hook files.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>See <a href="githooks.html">githooks(5)</a> for more general info on hook execution.</p>
</div>
</div>
</div>
<div class="sect1">
