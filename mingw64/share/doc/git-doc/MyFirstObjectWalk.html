...
(our test suite will notice and complain if you fail to do so).</p>
</div>
<div class="listingblock">
<div class="content">
...
<div class="paragraph">
<p>For our first example within <code>git walken</code>, we don&#8217;t intend to use any other
...
a new function in <code>builtin/walken.c</code>:</p>
</div>
<div class="listingblock">
<div class="content">
<pre>static void init_walken_defaults(void)
{
        /*
...
<div class="paragraph">
<p>Make sure to add a line invoking it inside of <code>cmd_walken()</code>.</p>
</div>
<div class="listingblock">
<div class="content">
<pre>int cmd_walken(int argc, const char **argv, const char *prefix)
...
<div class="paragraph">
<p>Add a new function to <code>builtin/walken.c</code>:</p>
</div>
<div class="listingblock">
<div class="content">
...
<div class="paragraph">
<p>Add the <code>struct rev_info</code> and the <code>repo_init_revisions()</code> call:</p>
</div>
<div class="listingblock">
<div class="content">
<pre>int cmd_walken(int argc, const char **argv, const char *prefix)
...
<div class="paragraph">
<p>First some setup. Add <code>init_grep_defaults()</code> to <code>init_walken_defaults()</code> and add
<code>grep_config()</code> to <code>git_walken_config()</code>:</p>
</div>
<div class="listingblock">
<div class="content">
<pre>static void init_walken_defaults(void)
...
arguments to the unfiltered version.</p>
</div>
<div class="ulist">
<ul>
<li>
<p><code>struct list_objects_filter_options *filter_options</code>: This is a struct which
stores a filter-spec as outlined in <code>Documentation/rev-list-options.txt</code>.</p>
</li>
<li>
<p><code>struct rev_info *revs</code>: This is the <code>rev_info</code> used for the walk.</p>
</li>
<li>
...
<div class="paragraph">
<p>It looks like this <code>traverse_commit_list_filtered()</code> uses callbacks we provide
...
Complete your implementation of <code>walken_object_walk()</code>:</p>
</div>
<div class="listingblock">
<div class="content">
<pre>        traverse_commit_list(rev, walken_show_commit, walken_show_object, NULL);
...
<div class="paragraph">
<p>First, we&#8217;ll need to <code>#include "list-objects-filter-options.h</code>" and set up the
<code>struct list_objects_filter_options</code> at the top of the function.</p>
</div>
<div class="listingblock">
<div class="content">
<pre>static void walken_object_walk(struct rev_info *rev)
...
<div class="paragraph">
<p><code>struct list_objects_filter_options</code> is usually built directly from a command
