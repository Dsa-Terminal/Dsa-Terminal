...
<code>-M</code>, except instead of the branch being renamed it along with its
config and reflog will be copied to a new name.</p>
</div>
<div class="paragraph">
...
<dd>
<p>Alter the sha1&#8217;s minimum display length in the output listing.
...
start-point is either a local or remote-tracking branch.</p>
</div>
</dd>
