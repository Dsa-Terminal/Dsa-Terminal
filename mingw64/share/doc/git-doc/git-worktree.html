...
<body class="manpage">
<div id="header">
<h1>git-worktree(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<div class="dlist">
<dl>
<dt class="hdlist1">add &lt;path&gt; [&lt;commit-ish&gt;]</dt>
<dd>
...
allows the move to proceed; use --force twice if the destination is locked.</p>
</div>
<div class="paragraph">
...
<dt class="hdlist1">-b &lt;new-branch&gt;</dt>
<dt class="hdlist1">-B &lt;new-branch&gt;</dt>
<dd>
...
in <a href="git-checkout.html">git-checkout(1)</a>.</p>
</dd>
...
in <a href="git-read-tree.html">git-read-tree(1)</a>.</p>
</dd>
<dt class="hdlist1">--[no-]guess-remote</dt>
<dd>
...
<dt class="hdlist1">--reason &lt;string&gt;</dt>
<dd>
...
<div class="paragraph">
<p>For example, main-worktree/HEAD or main-worktree/refs/bisect/good
...
<div class="paragraph">
<p>To access refs, it&#8217;s best not to look inside GIT_DIR directly. Instead
...
<div class="sectionbody">
<div class="paragraph">
<p>By default, the repository "config" file is shared across all working
...
<div class="paragraph">
<p>See <a href="gitrepository-layout.html">gitrepository-layout(5)</a> for more information. The rule of
...
<a href="gitrepository-layout.html">gitrepository-layout(5)</a> for details.</p>
</div>
<div class="paragraph">
<p>When extensions.worktreeConfig is enabled, the config file
