...
<dd>
<p>Show the absolute path of the top-level directory of the working
tree. If there is no working tree, report an error.</p>
</dd>
...
<div class="dlist">
<dl>
<dt class="hdlist1"><code>&lt;opt-spec&gt;</code></dt>
<dd>
...
<dt class="hdlist1"><code>&lt;arg-hint&gt;</code></dt>
<dd>
...
<div class="listingblock">
<div class="content">
<pre>$ git rev-parse --verify $REV^{commit}</pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre>$ git rev-parse --default master --verify $REV</pre>
</div>
</div>
<div class="paragraph">
