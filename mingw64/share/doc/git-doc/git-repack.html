...
<body class="manpage">
<div id="header">
<h1>git-repack(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<pre class="content"><em>git repack</em> [-a] [-A] [-d] [-f] [-F] [-l] [-n] [-q] [-b] [--window=&lt;n&gt;] [--depth=&lt;n&gt;] [--threads=&lt;n&gt;] [--keep-pack=&lt;pack-name&gt;]</pre>
</div>
</div>
</div>
<div class="sect1">
...
with the next <em>git gc</em> invocation. See <a href="git-gc.html">git-gc(1)</a>.</p>
</dd>
...
<a href="git-pack-objects.html">git-pack-objects(1)</a>.</p>
</dd>
...
over HTTP or FTP.  See <a href="git-update-server-info.html">git-update-server-info(1)</a>.</p>
</dd>
...
by the number of threads used by <a href="git-pack-objects.html">git-pack-objects(1)</a>.</p>
</dd>
...
<dt class="hdlist1">--write-bitmap-index</dt>
<dd>
...
has no effect if multiple packfiles are created.</p>
</dd>
<dt class="hdlist1">--pack-kept-objects</dt>
<dd>
...
<dt class="hdlist1">--unpack-unreachable=&lt;when&gt;</dt>
<dd>
