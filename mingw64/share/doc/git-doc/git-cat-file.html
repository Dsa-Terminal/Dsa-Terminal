...
the "SPECIFYING REVISIONS" section in <a href="gitrevisions.html">gitrevisions(7)</a>.</p>
</dd>
...
<dd>
<p>Exit with zero status if &lt;object&gt; exists and is a valid
...
<dd>
<p>Typically this matches the real type of &lt;object&gt; but asking
...
the form &lt;tree-ish&gt;:&lt;path&gt;, or :&lt;path&gt;.</p>
</dd>
<dt class="hdlist1">--path=&lt;path&gt;</dt>
<dd>
<p>For use with --textconv or --filters, to allow specifying an object
...
<dt class="hdlist1">--batch-all-objects</dt>
<dd>
...
the objects are visited in order sorted by their hashes.</p>
</dd>
...
<dd>
<p>With --batch or --batch-check, follow symlinks inside the
...
<div class="sectionbody">
<div class="paragraph">
<p>If <code>-t</code> is specified, one of the &lt;type&gt;.</p>
</div>
<div class="paragraph">
<p>If <code>-s</code> is specified, the size of the &lt;object&gt; in bytes.</p>
</div>
<div class="paragraph">
<p>If <code>-e</code> is specified, no output, unless the &lt;object&gt; is malformed.</p>
</div>
<div class="paragraph">
<p>If <code>-p</code> is specified, the contents of &lt;object&gt; are pretty-printed.</p>
</div>
<div class="paragraph">
...
<div class="dlist">
<dl>
<dt class="hdlist1"><code>objectname</code></dt>
<dd>
...
<dt class="hdlist1"><code>objectsize:disk</code></dt>
<dd>
...
<dt class="hdlist1"><code>deltabase</code></dt>
<dd>
<p>If the object is stored as a delta on-disk, this expands to the
40-hex sha1 of the delta base object. Otherwise, expands to the
null sha1 (40 zeroes). See <code>CAVEATS</code> below.</p>
</dd>
...
<div class="paragraph">
<p>If --follow-symlinks is used, and a symlink in the repository points
...
<div class="paragraph">
<p>The symlink will either be absolute (beginning with a /), or relative
to the tree root.  For instance, if dir/link points to ../../foo, then
&lt;symlink&gt; will be ../foo.  &lt;size&gt; is the size of the symlink in bytes.</p>
</div>
<div class="paragraph">
<p>If --follow-symlinks is used, the following error messages will be
displayed:</p>
</div>
<div class="listingblock">
<div class="content">
