...
<body class="manpage">
<div id="header">
<h1>git-multi-pack-index(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<pre class="content"><em>git multi-pack-index</em> [--object-dir=&lt;dir&gt;] [--[no-]progress] &lt;subcommand&gt;</pre>
</div>
</div>
</div>
<div class="sect1">
...
<div class="dlist">
<dl>
<dt class="hdlist1">--object-dir=&lt;dir&gt;</dt>
<dd>
...
<code>&lt;dir&gt;/packs</code> for the pack-files to index.</p>
</dd>
...
afterward to remove all references to these pack-files.</p>
</dd>
<dt class="hdlist1">repack</dt>
<dd>
<p>Create a new pack-file containing objects in small pack-files
referenced by the multi-pack-index. If the size given by the
<code>--batch-size=&lt;size&gt;</code> argument is zero, then create a pack
...
<div class="paragraph">
<p>If <code>repack.packKeptObjects</code> is <code>false</code>, then any pack-files with an
associated <code>.keep</code> file will not be selected for the batch to repack.</p>
</div>
</dd>
</dl>
</div>
...
<ul>
<li>
<p>Write a MIDX file for the packfiles in the current .git folder.</p>
...
<li>
<p>Verify the MIDX file for the packfiles in the current .git folder.</p>
<div class="listingblock">
<div class="content">
...
<div class="sectionbody">
<div class="paragraph">
<p>See <a href="technical/multi-pack-index.html">The Multi-Pack-Index Design
Document</a> and <a href="technical/pack-format.html">The Multi-Pack-Index
Format</a> for more information on the multi-pack-index feature.</p>
</div>
</div>
</div>
<div class="sect1">
