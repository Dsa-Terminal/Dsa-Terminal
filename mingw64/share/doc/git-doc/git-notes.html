...
"notes.displayRef" configuration in <a href="git-log.html">git-log(1)</a>.</p>
</div>
<div class="paragraph">
...
<dt class="hdlist1">-C &lt;object&gt;</dt>
<dt class="hdlist1">--reuse-message=&lt;object&gt;</dt>
<dd>
...
<dt class="hdlist1">-c &lt;object&gt;</dt>
<dt class="hdlist1">--reedit-message=&lt;object&gt;</dt>
<dd>
...
<div class="dlist">
<dl>
<dt class="hdlist1"><code>GIT_NOTES_REF</code></dt>
<dd>
...
<dt class="hdlist1"><code>GIT_NOTES_DISPLAY_REF</code></dt>
<dd>
...
<dt class="hdlist1"><code>GIT_NOTES_REWRITE_MODE</code></dt>
<dd>
<p>When copying notes during a rewrite, what to do if the target
...
<dt class="hdlist1"><code>GIT_NOTES_REWRITE_REF</code></dt>
<dd>
...
<a href="#_footnoteref_1">1</a>. Permitted pathnames have the form <em>ab</em><code>/</code><em>cd</em><code>/</code><em>ef</em><code>/</code><em>&#8230;&#8203;</em><code>/</code><em>abcdef&#8230;&#8203;</em>: a sequence of directory names of two hexadecimal digits each followed by a filename with the rest of the object ID.
</div>
</div>
<div id="footer">
<div id="footer-text">
