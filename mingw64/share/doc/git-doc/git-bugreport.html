...
<body class="manpage">
<div id="header">
<h1>git-bugreport(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
<div class="sectionbody">
<p>git-bugreport - Collect information for user to file a bug report</p>
</div>
</div>
<div id="content">
<div class="sect1">
...
<div class="dlist">
<dl>
<dt class="hdlist1">-o &lt;path&gt;</dt>
<dt class="hdlist1">--output-directory &lt;path&gt;</dt>
<dd>
<p>Place the resulting bug report file in <code>&lt;path&gt;</code> instead of the root of
the Git repository.</p>
</dd>
<dt class="hdlist1">-s &lt;format&gt;</dt>
<dt class="hdlist1">--suffix &lt;format&gt;</dt>
<dd>
