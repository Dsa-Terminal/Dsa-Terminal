...
<dd>
<p>This option bypasses the pre-merge and commit-msg hooks.
...
<div class="paragraph">
<p>When set to <code>preserve</code> (deprecated in favor of <code>merges</code>), rebase with the
<code>--preserve-merges</code> option passed to <code>git rebase</code> so that locally created
merge commits will not be flattened.</p>
</div>
<div class="paragraph">
...
documented in <a href="git-config.html">git-config(1)</a>.</p>
</div>
</dd>
...
<dd>
<p>If the remote is fetched successfully, pull and add upstream
