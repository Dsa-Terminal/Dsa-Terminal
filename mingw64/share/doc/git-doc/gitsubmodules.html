...
<body class="manpage">
<div id="header">
<h1>gitsubmodules(7) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<div class="literalblock">
<div class="content">
<pre># Unlike the other commands below clone still needs
...
affects other git commands, see <a href="git-config.html">git-config(1)</a> for a complete list).</p>
</div>
</div>
</div>
<div class="sect1">
...
<div class="sectionbody">
<div class="paragraph">
<p><a href="git-submodule.html">git-submodule(1)</a>, <a href="gitmodules.html">gitmodules(5)</a>.</p>
</div>
</div>
</div>
<div class="sect1">
