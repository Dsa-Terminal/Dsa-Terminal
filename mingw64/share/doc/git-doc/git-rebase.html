...
running <em>git rebase --onto &lt;upstream&gt;&#8230;&#8203; &lt;upstream&gt;</em>.</p>
<div class="paragraph">
...
of upstream commits that need to be read.</p>
</div>
<div class="paragraph">
...
<dd>
<p>Use merging strategies to rebase.  When the recursive (default) merge
strategy is used, this allows rebase to be aware of renames on the
upstream side.  This is the default.</p>
<div class="paragraph">
...
be used to override --no-verify.  See also <a href="githooks.html">githooks(5)</a>.</p>
</dd>
...
<code>--no-fork-point</code>, otherwise the default is <code>--fork-point</code>.</p>
</div>
<div class="paragraph">
...
<dd>
<p>These flags are passed to the <em>git apply</em> program
...
<dd>
<p>These flags are passed to <em>git am</em> to easily change the dates
of the rebased commits (see <a href="git-am.html">git-am(1)</a>).</p>
<div class="paragraph">
<p>See also INCOMPATIBLE OPTIONS below.</p>
</div>
</dd>
...
<dd>
<p>Add a Signed-off-by: trailer to all the rebased commits. Note
...
<div class="paragraph">
<p>The <code>--rebase-merges</code> mode is similar in spirit to the deprecated
<code>--preserve-merges</code> but works with interactive rebases,
where commits can be reordered, inserted and dropped at will.</p>
</div>
<div class="paragraph">
...
<dd>
<p>[DEPRECATED: use <code>--rebase-merges</code> instead] Recreate merge commits
instead of flattening the history by replaying commits a merge commit
introduces. Merge conflict resolutions or manual amendments to merge
commits are not preserved.</p>
<div class="paragraph">
<p>This uses the <code>--interactive</code> machinery internally, but combining it
with the <code>--interactive</code> option explicitly is generally not a good
idea unless you know what you are doing (see BUGS below).</p>
</div>
<div class="paragraph">
<p>See also INCOMPATIBLE OPTIONS below.</p>
</div>
...
<dd>
<p>When the commit log message begins with "squash! &#8230;&#8203;" (or
...
the <code>--fixup</code>/<code>--squash</code> options of <a href="git-commit.html">git-commit(1)</a>.</p>
<div class="paragraph">
...
<li>
<p>--committer-date-is-author-date</p>
</li>
<li>
<p>--ignore-date</p>
</li>
...
<ul>
<li>
<p>--preserve-merges and --interactive</p>
</li>
<li>
<p>--preserve-merges and --signoff</p>
</li>
<li>
<p>--preserve-merges and --rebase-merges</p>
</li>
<li>
<p>--preserve-merges and --empty=</p>
</li>
<li>
...
about the merge base commit whatsoever.</p>
</div>
<div class="paragraph">
...
See also <a href="git-diff.html">git-diff(1)</a> <code>--patience</code>.</p>
</dd>
...
<a href="git-diff.html">git-diff(1)</a> <code>--diff-algorithm</code>.</p>
</dd>
...
but omits the commit messages of commits with the "fixup" command.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>At this time, the <code>merge</code> command will <strong>always</strong> use the <code>recursive</code>
...
<code>refs/rewritten/onto</code> would correspond to the label <code>onto</code>, for example).</p>
</div>
<div class="paragraph">
...
<div class="sectionbody">
<div class="paragraph">
<p>The todo list presented by the deprecated <code>--preserve-merges --interactive</code>
does not represent the topology of the revision graph (use <code>--rebase-merges</code>
instead).  Editing commits and rewording their commit messages should work
fine, but attempts to reorder commits tend to produce counterintuitive results.
Use <code>--rebase-merges</code> in such scenarios instead.</p>
</div>
<div class="paragraph">
<p>For example, an attempt to rearrange</p>
</div>
<div class="listingblock">
<div class="content">
<pre>1 --- 2 --- 3 --- 4 --- 5</pre>
...
<div class="paragraph">
<p>by moving the "pick 4" line will result in the following history:</p>
</div>
<div class="listingblock">
<div class="content">
<pre>        3
