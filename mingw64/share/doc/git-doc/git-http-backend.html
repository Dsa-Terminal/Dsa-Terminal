...
<body class="manpage">
<div id="header">
<h1>git-http-backend(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<div class="dlist">
<dl>
<dt class="hdlist1">http.getanyfile</dt>
<dd>
...
<dt class="hdlist1">http.uploadpack</dt>
<dd>
<p>This serves <em>git fetch-pack</em> and <em>git ls-remote</em> clients.
It is enabled by default, but a repository can disable it
by setting this configuration item to <code>false</code>.</p>
</dd>
<dt class="hdlist1">http.receivepack</dt>
<dd>
...
<div class="dlist">
<dl>
<dt class="hdlist1">Apache 2.x</dt>
<dd>
...
<div class="paragraph">
<p>To serve multiple repositories from different <a href="gitnamespaces.html">gitnamespaces(7)</a> in a
single repository:</p>
</div>
<div class="listingblock">
<div class="content">
...
<dt class="hdlist1">Accelerated static Apache 2.x</dt>
<dd>
