...
<a href="git-fast-import.html">git-fast-import(1)</a> for more details on the import case.</p>
</div>
</div>
</div>
<div class="sect1">
...
<dt class="hdlist1">--keep-largest-pack</dt>
<dd>
...
<div class="sectionbody">
<div class="paragraph">
<p>When the <code>--aggressive</code> option is supplied, <a href="git-repack.html">git-repack(1)</a> will
...
by <em>git notes</em> under refs/notes/, reflogs (which may reference commits
in branches that were later amended or rewound), and anything else in
the refs/* namespace.  If you are expecting some objects to be deleted
and they aren&#8217;t, check all of those locations and decide whether it
makes sense in your case to remove those references.</p>
</div>
<div class="paragraph">
...
<a href="githooks.html">githooks(5)</a> for more information.</p>
</div>
</div>
</div>
<div class="sect1">
...
<a href="git-rerere.html">git-rerere(1)</a></p>
</div>
</div>
</div>
<div class="sect1">
