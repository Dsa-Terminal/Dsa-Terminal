...
<body class="manpage">
<div id="header">
<h1>git-commit-graph(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<div class="dlist">
<dl>
<dt class="hdlist1">--object-dir</dt>
<dd>
...
<div class="dlist">
<dl>
<dt class="hdlist1"><em>write</em></dt>
<dd>
...
with <code>--stdin-packs</code> or <code>--reachable</code>.)</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>With the <code>--changed-paths</code> option, compute and write information about the
paths changed between a commit and its first parent. This operation can
take a while on large repositories. It provides significant performance gains
for getting history of a directory or a file with <code>git log -- &lt;path&gt;</code>.</p>
</div>
<div class="paragraph">
<p>With the <code>--split[=&lt;strategy&gt;]</code> option, write the commit-graph as a
...
<ul>
<li>
<p>If <code>--split=no-merge</code> is specified, a merge is never performed, and
the remaining options are ignored. <code>--split=replace</code> overwrites the
existing chain with a new one. A bare <code>--split</code> defers to the remaining
...
incremental holds the entire graph).</p>
</li>
<li>
...
<dt class="hdlist1"><em>verify</em></dt>
<dd>
