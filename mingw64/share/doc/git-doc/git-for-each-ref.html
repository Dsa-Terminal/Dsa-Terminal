...
<body class="manpage">
<div id="header">
<h1>git-for-each-ref(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<dt class="hdlist1">objectname</dt>
<dd>
...
<dt class="hdlist1">worktreepath</dt>
<dd>
...
be used to specify the value in the header field.</p>
</div>
<div class="paragraph">
...
and <code>date</code> to extract the named component.</p>
</div>
<div class="paragraph">
...
<code>trailers:unfold</code>. Both can be used together as <code>trailers:unfold,only</code>.</p>
</div>
<div class="paragraph">
...
values the <code>--date</code> option to <a href="git-rev-list.html">git-rev-list(1)</a> takes).</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>An example to show the usage of %(if)&#8230;&#8203;%(then)&#8230;&#8203;%(else)&#8230;&#8203;%(end).
...
<div class="paragraph">
<p>An example to show the usage of %(if)&#8230;&#8203;%(then)&#8230;&#8203;%(end).
...
<div class="sectionbody">
<div class="paragraph">
<p><a href="git-show-ref.html">git-show-ref(1)</a></p>
</div>
</div>
</div>
<div class="sect1">
