...
merge strategy.  See <a href="git-merge.html">git-merge(1)</a> for details.</p>
</dd>
...
<div class="dlist">
<dl>
<dt class="hdlist1"><code>git cherry-pick master</code></dt>
<dd>
<p>Apply the change introduced by the commit at the tip of the
master branch and create a new commit with this change.</p>
</dd>
<dt class="hdlist1"><code>git cherry-pick ..master</code></dt>
<dt class="hdlist1"><code>git cherry-pick ^HEAD master</code></dt>
<dd>
<p>Apply the changes introduced by all commits that are ancestors
of master but not of HEAD to produce new commits.</p>
</dd>
<dt class="hdlist1"><code>git cherry-pick maint next ^master</code></dt>
<dt class="hdlist1"><code>git cherry-pick maint master..next</code></dt>
<dd>
...
<dt class="hdlist1"><code>git cherry-pick master~4 master~2</code></dt>
<dd>
<p>Apply the changes introduced by the fifth and third last
commits pointed to by master and create 2 new commits with
these changes.</p>
</dd>
<dt class="hdlist1"><code>git cherry-pick -n master~1 next</code></dt>
<dd>
...
<dt class="hdlist1"><code>git cherry-pick --ff ..next</code></dt>
<dd>
...
<dt class="hdlist1"><code>git rev-list --reverse master -- README | git cherry-pick -n --stdin</code></dt>
<dd>
...
$ git reset --merge ORIG_HEAD        <b class="conum">(3)</b>
...
<div class="sectionbody">
<div class="paragraph">
<p><a href="git-revert.html">git-revert(1)</a></p>
</div>
</div>
</div>
<div class="sect1">
