...
<div class="paragraph">
<p>The command takes options applicable to the <code>git rev-list</code>
...
shown. The default option is <em>short</em>.</p>
</dd>
...
options may be given. See <a href="git-diff-files.html">git-diff-files(1)</a> for more options.</p>
</div>
<div class="dlist">
<dl>
...
<dd>
<p>See <a href="git-shortlog.html">git-shortlog(1)</a>.</p>
</dd>
