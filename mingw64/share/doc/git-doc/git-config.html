...
prepend a single exclamation mark in front (see also <a href="#EXAMPLES">EXAMPLES</a>).</p>
</div>
<div class="paragraph">
...
command by using the <code>-c</code> option. See <a href="git.html">git(1)</a> for details.</p>
</div>
<div class="paragraph">
...
color with <code>bright</code>, like <code>brightred</code>.</p>
</div>
<div class="paragraph">
...
<dd>
<p>Advice shown when <a href="git-fetch.html">git-fetch(1)</a> takes a long time
...
<dd>
<p>Advice shown when <a href="git-push.html">git-push(1)</a> fails due to a
non-fast-forward update to the current branch.</p>
</dd>
<dt class="hdlist1">pushNonFFMatching</dt>
<dd>
<p>Advice shown when you ran <a href="git-push.html">git-push(1)</a> and pushed
...
<a href="git-checkout.html">git-checkout(1)</a> when switching branch.</p>
</dd>
<dt class="hdlist1">statusUoption</dt>
<dd>
<p>Advise to consider using the <code>-u</code> option to <a href="git-status.html">git-status(1)</a>
when the command takes more than 2 seconds to enumerate untracked
files.</p>
</dd>
<dt class="hdlist1">commitBeforeMerge</dt>
<dd>
<p>Advice shown when <a href="git-merge.html">git-merge(1)</a> refuses to
merge to avoid overwriting local changes.</p>
</dd>
<dt class="hdlist1">resetQuiet</dt>
<dd>
<p>Advice to consider using the <code>--quiet</code> option to <a href="git-reset.html">git-reset(1)</a>
...
<a href="git-am.html">git-am(1)</a> fails to apply it.</p>
</dd>
<dt class="hdlist1">rmHints</dt>
<dd>
<p>In case of failure in the output of <a href="git-rm.html">git-rm(1)</a>,
...
See the "fsmonitor-watchman" section of <a href="githooks.html">githooks(5)</a>.</p>
</dd>
...
<dt class="hdlist1">core.restrictinheritedhandles</dt>
<dd>
...
<dt class="hdlist1">add.interactive.useBuiltin</dt>
<dd>
...
<dt class="hdlist1">blame.markUnblamables</dt>
<dd>
...
<div class="paragraph">
<p>When <code>preserve</code> (or just <em>p</em>, deprecated in favor of <code>merges</code>), also pass
<code>--preserve-merges</code> along to <em>git rebase</em> so that locally committed merge
commits will not be flattened by running <em>git pull</em>.</p>
</div>
<div class="paragraph">
...
<dd>
<p>When you run <em>git checkout &lt;something&gt;</em>
or <em>git switch &lt;something&gt;</em> and only have one
...
<a href="git-checkout.html">git-checkout(1)</a> when <em>git checkout &lt;something&gt;</em>
or <em>git switch &lt;something&gt;</em>
will checkout the <em>&lt;something&gt;</em> branch on another remote,
and by <a href="git-worktree.html">git-worktree(1)</a> when <em>git worktree add</em> refers to a
...
See <a href="git-commit.html">git-commit(1)</a>.</p>
</dd>
...
<li>
<p><code>protocol.version=2</code> speeds up fetches from repositories with many refs by
...
OUTPUT in <a href="git-fetch.html">git-fetch(1)</a> for detail.</p>
</dd>
...
<div class="paragraph">
<p>See also the <code>--negotiation-tip</code> option for <a href="git-fetch.html">git-fetch(1)</a>.</p>
</div>
</dd>
...
<div class="paragraph">
<p>Setting <code>fsck.&lt;msg-id&gt;</code> will be picked up by <a href="git-fsck.html">git-fsck(1)</a>, but
...
repository; see the "NOTES" section of <a href="git-gc.html">git-gc(1)</a>.</p>
</dd>
...
See <code>grep.threads</code> in <a href="git-grep.html">git-grep(1)</a> for more information.</p>
</dd>
...
(See the "TEMPLATE DIRECTORY" section of <a href="git-init.html">git-init(1)</a>.)</p>
</dd>
<dt class="hdlist1">init.defaultBranch</dt>
<dd>
<p>Allows overriding the default branch name e.g. when initializing
a new repository or when cloning an empty repository.</p>
</dd>
...
passed as argument. (See <a href="git-help.html">git-help(1)</a>.)</p>
</dd>
...
<dd>
<p>Unused configuration variable. Used in Git versions 2.20 and
...
<dd>
<p>The push URL of a remote repository.  See <a href="git-push.html">git-push(1)</a>.</p>
</dd>
...
<dd>
<p>See <a href="git-send-email.html">git-send-email(1)</a> for description.</p>
</dd>
...
<dt class="hdlist1">stash.useBuiltin</dt>
<dd>
...
See description of <em>show</em> command in <a href="git-stash.html">git-stash(1)</a>.</p>
</dd>
