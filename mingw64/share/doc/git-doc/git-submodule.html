...
<div class="paragraph">
<p>For more information about submodules, see <a href="gitsubmodules.html">gitsubmodules(7)</a>.</p>
</div>
</div>
</div>
<div class="sect1">
...
<dt class="hdlist1">deinit [-f|--force] (--all|[--] &lt;path&gt;&#8230;&#8203;)</dt>
<dd>
...
<dt class="hdlist1">update [--init] [--remote] [-N|--no-fetch] [--[no-]recommend-shallow] [-f|--force] [--checkout|--rebase|--merge] [--reference &lt;repository&gt;] [--depth &lt;depth&gt;] [--recursive] [--jobs &lt;n&gt;] [--[no-]single-branch] [--] [&lt;path&gt;&#8230;&#8203;]</dt>
<dd>
<div class="openblock">
<div class="content">
<div class="paragraph">
...
<div class="dlist">
<dl>
<dt class="hdlist1">custom command</dt>
<dd>
...
<dt class="hdlist1">set-branch (-b|--branch) &lt;branch&gt; [--] &lt;path&gt;</dt>
<dt class="hdlist1">set-branch (-d|--default) [--] &lt;path&gt;</dt>
<dd>
...
<dt class="hdlist1">set-url [--] &lt;path&gt; &lt;newurl&gt;</dt>
<dd>
<p>Sets the URL of the specified submodule to &lt;newurl&gt;. Then, it will
automatically synchronize the submodule&#8217;s new remote URL
configuration.</p>
</dd>
<dt class="hdlist1">summary [--cached|--files] [(-n|--summary-limit) &lt;n&gt;] [commit] [--] [&lt;path&gt;&#8230;&#8203;]</dt>
<dd>
...
explicit commit).</p>
<div class="paragraph">
<p>Using the <code>--submodule=log</code> option with <a href="git-diff.html">git-diff(1)</a> will provide that
information too.</p>
</div>
</dd>
<dt class="hdlist1">foreach [--recursive] &lt;command&gt;</dt>
<dd>
...
<dt class="hdlist1">sync [--recursive] [--] [&lt;path&gt;&#8230;&#8203;]</dt>
<dd>
...
<dt class="hdlist1">absorbgitdirs</dt>
<dd>
...
this option will be passed to the <a href="git-clone.html">git-clone(1)</a> command.</p>
<div class="paragraph">
...
<dt class="hdlist1">--dissociate</dt>
<dd>
<p>This option is only valid for add and update commands.  These
commands sometimes need to clone a remote repository. In this case,
this option will be passed to the <a href="git-clone.html">git-clone(1)</a> command.</p>
...
<dt class="hdlist1">--[no-]recommend-shallow</dt>
<dd>
<p>This option is only valid for the update command.
...
<div class="sectionbody">
<div class="paragraph">
<p><a href="gitsubmodules.html">gitsubmodules(7)</a>, <a href="gitmodules.html">gitmodules(5)</a>.</p>
</div>
</div>
</div>
<div class="sect1">
