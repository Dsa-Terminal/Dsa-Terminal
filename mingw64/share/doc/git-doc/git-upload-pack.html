...
<body class="manpage">
<div id="header">
<h1>git-upload-pack(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<div class="dlist">
<dl>
<dt class="hdlist1">--[no-]strict</dt>
<dd>
<p>Do not try &lt;directory&gt;/.git/ if &lt;directory&gt; is no Git directory.</p>
</dd>
<dt class="hdlist1">--timeout=&lt;n&gt;</dt>
<dd>
<p>Interrupt transfer after &lt;n&gt; seconds of inactivity.</p>
</dd>
<dt class="hdlist1">--stateless-rpc</dt>
<dd>
...
<dt class="hdlist1">--advertise-refs</dt>
<dd>
<p>Only the initial ref advertisement is output, and the program exits
immediately. This fits with the HTTP GET request model, where
no request content is received but a response must be produced.</p>
</dd>
...
<div class="sectionbody">
<div class="paragraph">
<p><a href="gitnamespaces.html">gitnamespaces(7)</a></p>
</div>
</div>
</div>
<div class="sect1">
