...
<div class="sect3">
<h4 id="_git_devel_on_freenode"><a class="anchor" href="#_git_devel_on_freenode"></a><a href="https://webchat.freenode.net/#git-devel">#git-devel</a> on Freenode</h4>
<div class="paragraph">
...
don&#8217;t remove the Signed-off-by line which was added by <code>-s</code> above.</p>
</div>
<div class="listingblock">
<div class="content">
...
<td class="content">
You may need to install the package <code>asciidoc</code> to get this to work.
</td>
</tr>
</table>
</div>
...
<div class="listingblock">
<div class="content">
<pre>$ git format-patch --cover-letter -o psuh/ master..psuh</pre>
</div>
</div>
<div class="paragraph">
<p>The <code>--cover-letter</code> parameter tells <code>format-patch</code> to create a cover letter
template for you. You will need to fill in the template before you&#8217;re ready
to send - but for now, the template will be next to your other patches.</p>
</div>
<div class="paragraph">
<p>The <code>-o psuh/</code> parameter tells <code>format-patch</code> to place the patch files into a
directory. This is useful because <code>git send-email</code> can take a directory and
send out all the patches from there.</p>
</div>
<div class="paragraph">
<p><code>master..psuh</code> tells <code>format-patch</code> to generate patches for the difference
...
shaped the way you want it to look for your patchset v2.</p>
</div>
<div class="paragraph">
<p>When you&#8217;re ready with the next iteration of your patch, the process is fairly
similar.</p>
</div>
<div class="paragraph">
<p>First, generate your v2 patches again:</p>
</div>
<div class="listingblock">
<div class="content">
<pre>$ git format-patch -v2 --cover-letter -o psuh/ master..psuh</pre>
</div>
</div>
<div class="paragraph">
<p>This will add your v2 patches, all named like <code>v2-000n-my-commit-subject.patch</code>,
to the <code>psuh/</code> directory. You may notice that they are sitting alongside the v1
patches; that&#8217;s fine, but be careful when you are ready to send them.</p>
</div>
<div class="paragraph">
