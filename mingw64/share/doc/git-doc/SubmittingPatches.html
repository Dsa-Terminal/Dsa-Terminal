...
branch, use the format "abbreviated hash (subject, date)", like this:</p>
</div>
...
patch, re-send it with "To:" set to the maintainer<sup class="footnote">[<a id="_footnoteref_2" class="footnote" href="#_footnotedef_2" title="View footnote.">2</a>]</sup> and "cc:" the
list<sup class="footnote">[<a id="_footnoteref_3" class="footnote" href="#_footnotedef_3" title="View footnote.">3</a>]</sup> for inclusion.</p>
</div>
<div class="paragraph">
