...
<dd>
<p>Run <code>git gc --auto</code> at the end to perform garbage collection
if needed. This is enabled by default.</p>
</dd>
...
<code>fetch.recurseSubmodules</code> is set (see <a href="git-config.html">git-config(1)</a>).</p>
</dd>
