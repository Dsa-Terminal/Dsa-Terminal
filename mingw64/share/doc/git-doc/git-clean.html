...
<dt class="hdlist1">-e &lt;pattern&gt;</dt>
<dt class="hdlist1">--exclude=&lt;pattern&gt;</dt>
<dd>
<p>Use the given exclude pattern in addition to the standard ignore rules
(see <a href="gitignore.html">gitignore(5)</a>).</p>
</dd>
<dt class="hdlist1">-x</dt>
<dd>
<p>Don&#8217;t use the standard ignore rules (see <a href="gitignore.html">gitignore(5)</a>), but
...
<dt class="hdlist1">filter by pattern</dt>
<dd>
...
<dt class="hdlist1">select by numbers</dt>
<dd>
<p>This shows the files and directories to be deleted and issues an
