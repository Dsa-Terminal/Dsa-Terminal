...
<li>
<p>The core.multiPackIndex config setting must be on to consume MIDX files.</p>
</li>
<li>
...
<ul>
<li>
<p>Add a <em>verify</em> subcommand to the <em>git midx</em> builtin to verify the
contents of the multi-pack-index file match the offsets listed in
the corresponding pack-indexes.</p>
</li>
<li>
...
<li>
<p>The reachability bitmap is currently paired directly with a single
...
could point to a multi-pack-index and be updated independently.</p>
</li>
<li>
...
<li>
<p>The partial clone feature records special "promisor" packs that
may point to objects that are not stored locally, but available
on request to a server. The multi-pack-index does not currently
track these promisor packs.</p>
</li>
</ul>
</div>
</div>
