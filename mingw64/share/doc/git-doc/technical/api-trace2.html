...
command line config settings.</p>
</div>
</div>
</div>
<div class="sect1">
...
<div class="paragraph">
<p>The normal format target is a tradition printf format and similar
...
<div class="sectionbody">
<div class="paragraph">
<p>All public Trace2 functions and macros are defined in <code>trace2.h</code> and
<code>trace2.c</code>.  All public symbols are prefixed with <code>trace2_</code>.</p>
</div>
<div class="paragraph">
...
and should only be used by functions in <code>trace2.c</code>.</p>
</div>
</div>
</div>
<div class="sect1">
...
<div class="sectionbody">
<div class="paragraph">
<p>The functions defined by the Trace2 API are declared and documented
...
take a varargs argument.</p>
</div>
<div class="paragraph">
<p>There are CPP wrapper macros and ifdefs to hide most of these details.
See <code>trace2.h</code> for more details.  The following discussion will only
describe the simplified forms.</p>
</div>
</div>
</div>
<div class="sect1">
...
<div class="sectionbody">
<div class="paragraph">
<p>All Trace2 API functions send a message to all of the active
Trace2 Targets.  This section describes the set of available
messages.</p>
</div>
<div class="paragraph">
<p>It helps to divide these functions into groups for discussion
purposes.</p>
</div>
<div class="sect2">
<h3 id="_basic_command_messages">Basic Command Messages</h3>
<div class="paragraph">
<p>These are concerned with the lifetime of the overall git process.
e.g: <code>void trace2_initialize_clock()</code>, <code>void trace2_initialize()</code>,
<code>int trace2_is_enabled()</code>, <code>void trace2_cmd_start(int argc, const char **argv)</code>.</p>
</div>
</div>
<div class="sect2">
<h3 id="_command_detail_messages">Command Detail Messages</h3>
<div class="paragraph">
<p>These are concerned with describing the specific Git command
after the command line, config, and environment are inspected.
e.g: <code>void trace2_cmd_name(const char *name)</code>,
<code>void trace2_cmd_mode(const char *mode)</code>.</p>
</div>
</div>
<div class="sect2">
<h3 id="_child_process_messages">Child Process Messages</h3>
<div class="paragraph">
<p>These are concerned with the various spawned child processes,
including shell scripts, git commands, editors, pagers, and hooks.</p>
</div>
<div class="paragraph">
<p>e.g: <code>void trace2_child_start(struct child_process *cmd)</code>.</p>
</div>
</div>
<div class="sect2">
<h3 id="_git_thread_messages">Git Thread Messages</h3>
<div class="paragraph">
<p>These messages are concerned with Git thread usage.</p>
</div>
<div class="paragraph">
<p>e.g: <code>void trace2_thread_start(const char *thread_name)</code>.</p>
</div>
</div>
<div class="sect2">
<h3 id="_region_and_data_messages">Region and Data Messages</h3>
<div class="paragraph">
<p>These are concerned with recording performance data
over regions or spans of code. e.g:
<code>void trace2_region_enter(const char *category, const char *label, const struct repository *repo)</code>.</p>
</div>
<div class="paragraph">
<p>Refer to trace2.h for details about all trace2 functions.</p>
</div>
</div>
</div>
</div>
...
<div class="dlist">
<dl>
<dt class="hdlist1"><code>&lt;event-name&gt;</code></dt>
<dd>
<p>is the event name.</p>
</dd>
<dt class="hdlist1"><code>&lt;event-message&gt;</code></dt>
<dd>
<p>is a free-form printf message intended for human consumption.</p>
<div class="paragraph">
...
<dt class="hdlist1"><code>&lt;thread-name&gt;</code></dt>
<dd>
...
<dt class="hdlist1"><code>&lt;repo-id&gt;</code></dt>
<dd>
...
<dt class="hdlist1"><code>&lt;t_abs&gt;</code></dt>
<dd>
<p>when present, is the absolute time in seconds since the
program started.</p>
</dd>
<dt class="hdlist1"><code>&lt;t_rel&gt;</code></dt>
<dd>
...
<dt class="hdlist1"><code>&lt;perf-event-message&gt;</code></dt>
<dd>
<p>is a free-form printf message intended for human consumption.</p>
</dd>
</dl>
...
<div class="sect3">
<h4 id="_common_keyvalue_pairs">Common Key/Value Pairs</h4>
<div class="paragraph">
...
<div class="dlist">
<dl>
<dt class="hdlist1"><code>"event":&lt;event&gt;</code></dt>
<dd>
<p>is the event name.</p>
</dd>
<dt class="hdlist1"><code>"sid":&lt;sid&gt;</code></dt>
<dd>
...
<dt class="hdlist1"><code>"thread":&lt;thread&gt;</code></dt>
<dd>
<p>is the thread name.</p>
</dd>
<dt class="hdlist1"><code>"time":&lt;time&gt;</code></dt>
<dd>
<p>is the UTC time of the event.</p>
</dd>
<dt class="hdlist1"><code>"file":&lt;filename&gt;</code></dt>
<dd>
<p>is source file generating the event.</p>
</dd>
<dt class="hdlist1"><code>"line":&lt;line-number&gt;</code></dt>
<dd>
<p>is the integer source line number generating the event.</p>
</dd>
<dt class="hdlist1"><code>"repo":&lt;repo-id&gt;</code></dt>
<dd>
...
<div class="sect3">
<h4 id="_event_specific_keyvalue_pairs">Event-Specific Key/Value Pairs</h4>
<div class="dlist">
<dl>
...
<dt class="hdlist1"><code>"atexit"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"signal"</code></dt>
<dd>
...
<dd>
<p>This event is emitted when one of the <code>error()</code>, <code>die()</code>,
or <code>usage()</code> functions are called.</p>
<div class="listingblock">
<div class="content">
<pre>{
        "event":"error",
...
<dt class="hdlist1"><code>"cmd_path"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"cmd_name"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"cmd_mode"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"child_start"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"child_exit"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"exec_result"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"thread_start"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"thread_exit"</code></dt>
<dd>
<p>This event is generated when a thread exits.  It is generated
from <strong>within</strong> the thread&#8217;s thread-proc (for TLS reasons).</p>
<div class="listingblock">
<div class="content">
<pre>{
        "event":"thread_exit",
...
<dt class="hdlist1"><code>"def_param"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"def_repo"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"region_enter"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"region_leave"</code></dt>
<dd>
...
<dt class="hdlist1"><code>"data-json"</code></dt>
<dd>
...
<dt class="hdlist1">Command Details</dt>
<dd>
...
<dt class="hdlist1">Child Processes</dt>
<dd>
...
<dd>
<p>Regions can be use to time an interesting section of code.</p>
<div class="listingblock">
<div class="content">
...
<dt class="hdlist1">Data Messages</dt>
<dd>
...
<dt class="hdlist1">Thread Events</dt>
<dd>
<p>Thread messages added to a thread-proc.</p>
<div class="paragraph">
<p>For example, the multithreaded preload-index code can be
instrumented with a region around the thread pool and then
per-thread start and exit events within the threadproc.</p>
</div>
<div class="listingblock">
<div class="content">
...
as each thread starts and allocates TLS storage.</p>
</div>
</dd>
</dl>
</div>
...
<ul>
<li>
<p>Updating existing tests that assume GIT_TRACE format messages.</p>
</li>
<li>
<p>How to best handle custom GIT_TRACE_&lt;key&gt; messages?</p>
<div class="ulist">
<ul>
<li>
<p>The GIT_TRACE_&lt;key&gt; mechanism allows each &lt;key&gt; to write to a
