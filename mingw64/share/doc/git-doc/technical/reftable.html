...
<li>
<p>Support atomic push with <code>O(size_of_update)</code> operations.</p>
</li>
<li>
...
expected block alignment. Unaligned files must set <code>block_size = 0</code>.</p>
</div>
<div class="paragraph">
...
<code>max_update_index + 1</code> is the next file&#8217;s <code>min_update_index</code>.</p>
</div>
</div>
<div class="sect3">
...
<div class="paragraph">
<p>Blocks begin with <code>block_type = 'r'</code> and a 3-byte <code>block_len</code> which
...
<div class="paragraph">
<p>Exactly <code>restart_count</code> 3-byte <code>restart_offset</code> values precedes the
...
header: <code>min_update_index + update_index_delta</code>.</p>
</div>
<div class="paragraph">
...
<li>
<p><code>0x3</code>: symbolic reference: <code>varint( target_len ) target</code></p>
</li>
</ul>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>Types <code>0x4..0x7</code> are reserved for future use.</p>
</div>
</div>
</div>
<div class="sect3">
...
<div class="paragraph">
<p>The index blocks begin with <code>block_type = 'i'</code> and a 3-byte <code>block_len</code>
...
<code>cnt_3 = 0</code> the actual count follows in a varint, <code>cnt_large</code>.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>A special case exists when <code>cnt_3 = 0</code> and <code>cnt_large = 0</code>: there are no
...
<div class="paragraph">
<p>Log blocks look similar to ref blocks, except <code>block_type = 'g'</code>.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>The <code>log_type = 0x0</code> is mostly useful for <code>git stash drop</code>, removing an
...
<div class="paragraph">
<p>For <code>log_type = 0x1</code>, the <code>log_data</code> section follows
...
as <code>sint16(-480)</code> and <code>GMT+0230</code> is <code>sint16(150)</code>.</p>
</div>
<div class="paragraph">
<p>The committer email does not contain <code>&lt;</code> or <code>&gt;</code>, it&#8217;s the value normally
found between the <code>&lt;&gt;</code> in a git commit object header.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>A collection of reftable files are stored in the <code>$GIT_DIR/reftable/</code>
directory:</p>
</div>
<div class="literalblock">
<div class="content">
<pre>00000001-00000001.log
00000002-00000002.ref
00000003-00000003.ref</pre>
</div>
</div>
<div class="paragraph">
<p>where reftable files are named by a unique name such as produced by the
function <code>${min_update_index}-${max_update_index}.ref</code>.</p>
</div>
<div class="paragraph">
...
<ul>
<li>
<p><code>.git/HEAD</code>, a regular file containing <code>ref: refs/heads/.invalid</code>.</p>
</li>
<li>
...
<code>max_update_index + 1</code>.</p>
</li>
<li>
<p>Prepare temp reftable <code>tmp_XXXXXX</code>, including log entries.</p>
</li>
<li>
<p>Rename <code>tmp_XXXXXX</code> to <code>${update_index}-${update_index}.ref</code>.</p>
</li>
<li>
...
<code>${min_update_index}-${max_update_index}_XXXXXX</code>.</p>
</li>
<li>
...
<li>
<p>Rename <code>${min_update_index}-${max_update_index}_XXXXXX</code> to
<code>${min_update_index}-${max_update_index}.ref</code>.</p>
</li>
<li>
