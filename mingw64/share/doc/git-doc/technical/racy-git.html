...
<div class="paragraph">
<p>There are cases Git needs to examine the differences between the
...
<div class="paragraph">
<p>Note: not all members in <code>struct stat</code> obtained via <code>lstat(2)</code>
...
<div class="paragraph">
<p>Running <code>git update-index</code> in the middle checked the racily
...
<ol class="arabic">
<li>
<p>Initial <code>git add .</code> of a large project.</p>
</li>
<li>
<p><code>git checkout</code> of a large project from an empty index into an
unpopulated working tree.</p>
</li>
</ol>
</div>
<div class="paragraph">
<p>Note: switching branches with <code>git checkout</code> keeps the cached
