...
<dt class="hdlist1"><code>PARSE_OPT_KEEP_UNKNOWN</code></dt>
<dd>
...
<dt class="hdlist1"><code>OPT_ARGUMENT(long, &amp;int_var, description)</code></dt>
<dd>
<p>Introduce a long-option argument that will be kept in <code>argv[]</code>.
If this option was seen, <code>int_var</code> will be set to one (except
if a <code>NULL</code> pointer was passed).</p>
</dd>
...
<dt class="hdlist1"><code>OPT_PASSTHRU_ARGV(short, long, &amp;argv_array_var, arg_str, description, flags)</code></dt>
<dd>
...
option has already set its value to the same <code>int_var</code>.</p>
</dd>
</dl>
</div>
<div class="paragraph">
