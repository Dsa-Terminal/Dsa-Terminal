...
<body class="manpage">
<div id="header">
<h1>gitrepository-layout(5) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
by creating a shallow clone.  See <a href="git-clone.html">git-clone(1)</a>.</p>
</li>
<li>
...
<dt class="hdlist1">objects/[0-9a-f][0-9a-f]</dt>
<dd>
...
<dt class="hdlist1">objects/pack</dt>
<dd>
<p>Packs (files that store many objects in compressed form,
along with index files to allow them to be randomly
accessed) are found in this directory.</p>
</dd>
<dt class="hdlist1">objects/info</dt>
<dd>
<p>Additional information about the object store is
recorded in this directory.</p>
</dd>
<dt class="hdlist1">objects/info/packs</dt>
<dd>
...
<dt class="hdlist1">objects/info/alternates</dt>
<dd>
...
is the same. See also <code>objects/info/http-alternates</code>.</p>
</dd>
<dt class="hdlist1">objects/info/http-alternates</dt>
<dd>
<p>This file records URLs to alternate object stores that
this object store borrows objects from, to be used when
the repository is fetched over HTTP.</p>
</dd>
<dt class="hdlist1">refs</dt>
<dd>
...
<dt class="hdlist1">packed-refs</dt>
<dd>
...
<dt class="hdlist1">config.worktree</dt>
<dd>
<p>Working directory specific configuration file for the main
working directory in multiple working directory setup (see
<a href="git-worktree.html">git-worktree(1)</a>).</p>
</dd>
...
<dd>
<p>When multiple working trees are used, most of files in
...
<dt class="hdlist1">sharedindex.&lt;SHA-1&gt;</dt>
<dd>
...
<dt class="hdlist1">info/grafts</dt>
<dd>
...
<dt class="hdlist1">info/exclude</dt>
<dd>
...
at it.  See also: <a href="gitignore.html">gitignore(5)</a>.</p>
</dd>
<dt class="hdlist1">info/attributes</dt>
<dd>
<p>Defines which attributes to assign to a path, similar to per-directory
<code>.gitattributes</code> files.   See also: <a href="gitattributes.html">gitattributes(5)</a>.</p>
</dd>
<dt class="hdlist1">info/sparse-checkout</dt>
<dd>
<p>This file stores sparse checkout patterns.
See also: <a href="git-read-tree.html">git-read-tree(1)</a>.</p>
</dd>
...
set and "$GIT_COMMON_DIR/logs" will be used instead.</p>
</dd>
<dt class="hdlist1">logs/refs/heads/<code>name</code></dt>
<dd>
<p>Records all changes made to the branch tip named <code>name</code>.</p>
</dd>
<dt class="hdlist1">logs/refs/tags/<code>name</code></dt>
<dd>
<p>Records all changes made to the tag named <code>name</code>.</p>
</dd>
<dt class="hdlist1">shallow</dt>
<dd>
...
<dt class="hdlist1">commondir</dt>
<dd>
<p>If this file exists, $GIT_COMMON_DIR (see <a href="git.html">git(1)</a>) will
...
<dt class="hdlist1">worktrees/&lt;id&gt;/gitdir</dt>
<dd>
...
<dt class="hdlist1">worktrees/&lt;id&gt;/locked</dt>
<dd>
...
<dt class="hdlist1">worktrees/&lt;id&gt;/config.worktree</dt>
<dd>
...
server process understands format <code>1</code>.</p>
</div>
<div class="paragraph">
...
<div class="sect2">
<h3 id="_version_0">Version <code>0</code></h3>
<div class="paragraph">
...
<div class="sect2">
<h3 id="_version_1">Version <code>1</code></h3>
<div class="paragraph">
<p>This format is identical to version <code>0</code>, with the following exceptions:</p>
</div>
<div class="olist arabic">
<ol class="arabic">
<li>
<p>When reading the <code>core.repositoryformatversion</code> variable, a git
implementation which supports version 1 MUST also read any
configuration keys found in the <code>extensions</code> section of the
configuration file.</p>
</li>
<li>
<p>If a version-1 repository specifies any <code>extensions.*</code> keys that
...
<div class="paragraph">
<p>This document will serve as the master list for extensions. Any
implementation wishing to define a new extension should make a note of
it here, in order to claim the name.</p>
</div>
<div class="paragraph">
<p>The defined extensions are:</p>
</div>
<div class="sect3">
<h4 id="_noop"><code>noop</code></h4>
<div class="paragraph">
...
<div class="sect3">
<h4 id="_preciousobjects"><code>preciousObjects</code></h4>
<div class="paragraph">
<p>When the config key <code>extensions.preciousObjects</code> is set to <code>true</code>,
objects in the repository MUST NOT be deleted (e.g., by <code>git-prune</code> or
<code>git repack -d</code>).</p>
</div>
</div>
<div class="sect3">
<h4 id="_partialclone"><code>partialclone</code></h4>
<div class="paragraph">
<p>When the config key <code>extensions.partialclone</code> is set, it indicates
...
<div class="sect3">
<h4 id="_worktreeconfig"><code>worktreeConfig</code></h4>
<div class="paragraph">
<p>If set, by default "git config" reads from both "config" and
