...
<body class="manpage">
<div id="header">
<h1>git-checkout-index(1) Manual Page</h1>
<h2 id="_name">NAME</h2>
...
<div class="sect1">
<h2 id="_using_temp_or_stageall">Using --temp or --stage=all</h2>
<div class="sectionbody">
<div class="paragraph">
...
<div class="dlist">
<dl>
<dt class="hdlist1">To update and refresh only the files already checked out</dt>
<dd>
<div class="listingblock">
<div class="content">
...
<dt class="hdlist1">Using <em>git checkout-index</em> to "export an entire tree"</dt>
<dd>
...
<dt class="hdlist1">Export files with a prefix</dt>
<dd>
<div class="listingblock">
<div class="content">
