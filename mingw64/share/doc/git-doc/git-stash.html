...
<div class="dlist">
<dl>
<dt class="hdlist1">push [-p|--patch] [-k|--[no-]keep-index] [-u|--include-untracked] [-a|--all] [-q|--quiet] [-m|--message &lt;message&gt;] [--pathspec-from-file=&lt;file&gt; [--pathspec-file-nul]] [--] [&lt;pathspec&gt;&#8230;&#8203;]</dt>
<dd>
...
<dt class="hdlist1">save [-p|--patch] [-k|--[no-]keep-index] [-u|--include-untracked] [-a|--all] [-q|--quiet] [&lt;message&gt;]</dt>
<dd>
...
<dt class="hdlist1">show [&lt;options&gt;] [&lt;stash&gt;]</dt>
<dd>
...
<dt class="hdlist1">--include-untracked</dt>
<dd>
<p>This option is only valid for <code>push</code> and <code>save</code> commands.</p>
<div class="paragraph">
<p>All untracked files are also stashed and then cleaned up with
...
<dt class="hdlist1">--keep-index</dt>
<dt class="hdlist1">--no-keep-index</dt>
<dd>
<p>This option is only valid for <code>push</code> and <code>save</code> commands.</p>
<div class="paragraph">
...
worktree. See the &#8220;Interactive Mode&#8221; section of <a href="git-add.html">git-add(1)</a>
...
<dt class="hdlist1">Recovering stash entries that were cleared/dropped erroneously</dt>
<dd>
...
<a href="git-switch.html">git-switch(1)</a></p>
</div>
</div>
</div>
<div class="sect1">
