...
<dt class="hdlist1">--reference[-if-able] &lt;repository&gt;</dt>
<dd>
...
<dd>
<p>Initialize the sparse-checkout file so the working
...
the <code>--filter</code> option in <a href="git-rev-list.html">git-rev-list(1)</a>.</p>
</dd>
...
<dd>
<p>Instead of using the remote name <code>origin</code> to keep track
of the upstream repository, use <code>&lt;name&gt;</code>.</p>
</dd>
...
<dt class="hdlist1">--recurse-submodules[=&lt;pathspec&gt;]</dt>
<dd>
...
<dt class="hdlist1">--[no-]shallow-submodules</dt>
<dd>
<p>All submodules which are cloned will be shallow with a depth of 1.</p>
</dd>
<dt class="hdlist1">--[no-]remote-submodules</dt>
<dd>
